...
#You can easily manually identify "bad" data that doesn't get picked up from the freezing line algorithm
...
```{r}
id_outlier(tempsal_data_calibrated, datecol="date_time", tempcol="temperature_calibrated", salcol="salinity_calibrated")
```

Note that you can incorporate this output into the flag colmun of your dataframe via indexing
